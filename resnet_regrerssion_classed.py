...
_config = {
    ...
    'batch_size':2,
    'initial_epoch': 0,
    'model_name': 'resnet_regression_multi_agg_classed',
...
def main(config=None):
    ...
    df_train_agg = matrix_to_dfclassed(matrix_train,classes_train)
    ...
    if os.path.isfile(model_filename) and config['continue_training']:
        ...
        model.add(Dense(units = len(classes_train.keys()) ))
